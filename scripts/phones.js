...
$(document).ready(function () {
    const phoneProducts = JSON.parse(localStorage.getItem("phoneProducts")) || [];
    const phoneContainer = $("#phones-container");

    // Check if there are laptop products to display
    if (phoneProducts.length === 0) {
        phoneContainer.append("<p class='text-center'>No products found in this category.</p>");
    } else {
